...
let todoList : Task [] = [];
let todoForm : HTMLFormElement= document.getElementById("todoForm") as HTMLFormElement;
let inputEL : HTMLInputElement= document.getElementById("myInput") as HTMLInputElement;
...
function createHtml(someList:Task[]){
    ...
    let todoContainer : HTMLDivElement = document.getElementById("taskList") as HTMLDivElement;
